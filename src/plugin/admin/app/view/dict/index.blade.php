...
<html lang="zh-cn">
    ...
    <body class="pear-container">
        ...
        <script type="text/html" id="table-toolbar">
            <button class="layui-btn layui-btn-primary layui-btn-md" lay-event="add" permission="app.admin.dict.insert">
                <i class="layui-icon layui-icon-add-1"></i>新增
            </button>
            <button class="layui-btn layui-btn-danger layui-btn-md" lay-event="batchRemove" permission="app.admin.dict.delete">
        ...
        <script type="text/html" id="table-bar">
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="edit" permission="app.admin.dict.update">编辑</button>
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="remove" permission="app.admin.dict.delete">删除</button>
        </script>
        ...
        <script>
				...
				let cols = [
          {
            ...
            templet: function (d) {
              ...
              return dicts.map(dict => `<span class="layui-badge" style="background-color: var(--global-primary-color)">${dict.name}: ${dict.value}</span>`).join(' ');
            },
          }, {
            title: "创建时间",
            field: "created_at",
