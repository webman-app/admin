...
<html lang="zh-cn">
	<head>
        ...
        <link rel="stylesheet" href="/app/admin/css/index/dashboard.css" />
	</head>
								...
								<div class="layui-col-xs4 layui-col-md4 top-panel-tips">
									<svg t="1591462430908" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
									 p-id="3170" width="200" height="200">
										...
										<path d="M181.5 151.3v302h-58v-302h58m0-36h-58c-19.9 0-36 16.1 36 36v302c0 19.9-16.1 36-36 36h-58c-19.9 0-36-16.1-36-36v-302c0-19.8-16.1-36-36-36z"
										 fill="#453B56" p-id="3173"></path>
										<path d="M266.4 210.7m-18 0a 18 18 0 1 0 36 0 18 18 0 1 0 -36 0 Z" fill="#453B56" p-id="3174"></path>
										...
										<path d="M649 908.7c-34.3 0-62.3-27.9-62.3-62.3 0-28.5 36.9-77.2 48.1-91.4 3.4-4.3 8.6-6.8 14.1-6.8s10.7 2.5 14.1 6.8c11.3 14.2 48.1 62.9 48.1 91.4c0.2 34.3-27.8 62.3-62.1 62.3z m0-112.3c-14.1 20.4-26.3 41.9-26.3 50 0 14.5 11.8 26.3 26.3 26.3s26.3-11.8 26.3-26.3c0-8.1-12.1-29.6-26.3-50z"
								...
								<div class="layui-col-xs4 layui-col-md4  top-panel-tips">
									<svg t="1591462464512" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
									 p-id="3311" width="200" height="200">
										...
										<path d="M621.8 467.5m-18 0a 18 18 0 1 0 36 0 a 18 18 0 1 0 -36 0 Z" fill="#453B56" p-id="3319"></path>
									</svg>
								</div>
							</div>
						</div>
								...
								<div class="layui-col-xs4 layui-col-md4 top-panel-tips">
									<svg t="1591462491887" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
									 p-id="3449" width="200" height="200">
										...
										<path d="M474.2 543.5m-18 0a 18 18 0 1 0 36 0 18 18 0 1 0 -36 0 Z" fill="#453B56" p-id="3456"></path>
			...
			layui.use(['layer', 'echarts', 'element', 'count'], function() {
				...
				var option = {
					...
					xAxis: [{
						...
						data: @json(array_keys($day7_detail))
					}, ],
					yAxis: [{
						type: 'value',
						offset: 15,
					...
					series: [{
						...
						smooth: true,
						data: @json(array_values($day7_detail))
					},]
