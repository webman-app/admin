...
<html lang="zh-cn">
    ...
    <body class="pear-container">
        ...
        <script type="text/html" id="table-toolbar">
            <button class="layui-btn layui-btn-primary layui-btn-md" lay-event="add" permission="app.admin.table.insert">
                <i class="layui-icon layui-icon-add-1"></i>新增
            </button>
            <button class="layui-btn layui-btn-danger layui-btn-md" lay-event="batchRemove" permission="app.admin.table.delete">
                <i class="layui-icon layui-icon-delete"></i>删除
            </button>
        </script>

        <script type="text/html" id="table-bar">
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="edit" permission="app.admin.table.update">编辑</button>
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="remove" permission="app.admin.table.delete">删除</button>
        </script>
