...
<html lang="zh-cn">
    ...
    <body class="pear-container">
        ...
        <script type="text/html" id="table-toolbar">
            <button class="layui-btn layui-btn-primary layui-btn-md" lay-event="add" permission="app.admin.user.insert">
                <i class="layui-icon layui-icon-add-1"></i>新增
            </button>
            <button class="layui-btn layui-btn-danger layui-btn-md" lay-event="batchRemove" permission="app.admin.user.delete">
        ...
        <script type="text/html" id="table-bar">
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="edit" permission="app.admin.user.update">编辑</button>
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="remove" permission="app.admin.user.delete">删除</button>
        </script>
