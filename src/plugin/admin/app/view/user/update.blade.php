                ...
                <div class="main-container mr-5">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" id="avatar" permission="app.admin.upload.avatar">
                                <i class="layui-icon layui-icon-upload"></i>上传图片
                            </button>
                            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" id="attachment-choose-avatar" permission="app.admin.upload.attachment">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div name="role" id="role" value="" ></div>
                        </div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        layui.use(["jquery", "xmSelect", "popup"], function() {
                            ...
                            let initValue = value ? value.toString().split(",").filter(function(v){return v!==''}).map(String) : [];
                            layui.$.ajax({
                                url: "/app/admin/role/select?format=select",
                                dataType: "json",
                                success: function (res) {
                                    let instance = layui.xmSelect.render({
                                        el: "#role",
                                        name: "role",
                                        initValue: initValue,
                                        data: res.data,
